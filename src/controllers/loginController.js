...
var LoginController = /** @class */ (function () {
    ...
    ;
    LoginController.prototype.login = function (req, res, signinController) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepo, login, senha, finded;
            return __generator(this, function (_a) {
                userRepo = new usuarioRepository_1.UsuarioRepo();
                login = req.body.login;
                senha = req.body.senha;
                finded = 0;
                userRepo.getOne(login, senha).then(function (result) {
                    //console.log(result)
                    if (result.length == 1) {
